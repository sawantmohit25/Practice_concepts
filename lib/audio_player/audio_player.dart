  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:AppBar(
        title:Column(
          children: [
            Text('PLAYING FROM ARTIST',style:TextStyle(fontSize:10.0),),
            Text('Alan Walker',style:TextStyle(fontSize:15.0,fontWeight:FontWeight.bold),)
          ],
        ),
        centerTitle:true,
        elevation:0,
              ...
              Row(
                ...
                children: [
                  ...
                  Container(decoration: BoxDecoration(
                      ...
                      border: Border.all(width: 5, color: Colors.white)),child: IconButton(icon:Icon(playButton,size:35,color:Colors.black,), onPressed:(){
                        if(!playing){
